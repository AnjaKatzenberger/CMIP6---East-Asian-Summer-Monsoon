...
fig, ax = plt.subplots()
ax2 = ax.twinx()
start = 2015 #1950 + window/2-1
end = 2101 - window/2-1
for s in range(len(aboves_per_year)):
    if ssp585_pr_model[s] in good_models:
        ax.plot(np.arange(start,end,1), aboves_per_year_movav[s][75:150], color = "darkblue", label = "models within 2 std", alpha=0.4)
    else:
        ax.plot(np.arange(start,end,1), aboves_per_year_movav[s][75:150], color = "darkorange", label = "models outside 2 std",alpha=0.4)

ax.plot(np.arange(start,end,1), median_good_movav[75:150], color = "darkblue", linewidth = 3)
ax.plot(np.arange(start,end,1), median_abs_movav[75:150], color = "darkred", linewidth = 3)

plt.xlim(2015,2100)
#plt.xticks(np.arange(2015,2101,50))
#ax.set_xticklabels(np.arange(2015,2101,50))
